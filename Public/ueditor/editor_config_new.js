...
,toolbars:[["Bold","Italic","Underline","Undo","Redo","InsertOrderedList","InsertUnorderedList","JustifyLeft","JustifyCenter","JustifyRight","AutoTypeSet","Attachment","Link","Unlink","InsertImage","SearchReplace","Preview","BlockQuote","Source","HighlightCode","FullScreen"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'bold':'','italic':'','underline':'','undo':'','redo':'','insertorderedlist':'','insertunorderedlist':'','justifyleft':'','justifycenter':'','justifyright':'','autotypeset':'','attachment':'','link':'','unlink':'','insertimage':'','searchreplace':'','preview':'','blockquote':'','source':'','highlightcode':'','fullscreen':''}
...
,textarea:"inner"  // 提交表单时，服务器获取编辑器提交内容的所用的参数，多实例时可以给容器name属性，会将name给定的值最为每个实例的键值，不用每次实例化的时候都设置这个值
